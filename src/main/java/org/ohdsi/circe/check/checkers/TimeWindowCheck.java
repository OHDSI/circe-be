...
public class TimeWindowCheck extends BaseCorelatedCriteriaCheck {
    ...
    protected void checkCriteria(CorelatedCriteria criteria, String groupName, WarningReporter reporter) {
        ...
        match(criteria)
                .when(c -> Objects.nonNull(c.startWindow)
                        && Comparisons.compareTo(observationFilter, c.startWindow) < 0)
                .then(() -> reporter.add(WARNING, name));
    }
}
