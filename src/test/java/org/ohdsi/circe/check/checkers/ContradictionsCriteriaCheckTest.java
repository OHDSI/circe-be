...
public class ContradictionsCriteriaCheckTest {
    private static final CohortExpression INCORRECT_EXPRESSION =
            CohortExpression.fromJson(ResourceHelper.GetResourceAsString("/checkers/contradictionsCriteriaCheckIncorrect.json"));
    private static final CohortExpression CORRECT_EXPRESSION =
            CohortExpression.fromJson(ResourceHelper.GetResourceAsString("/checkers/contradictionsCriteriaCheckCorrect.json"));

    private static final int WARNING_COUNT = 2;

    private BaseCheck check = new CriteriaContradictionsCheck();
